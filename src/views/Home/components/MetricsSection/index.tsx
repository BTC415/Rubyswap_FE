...
import { Heading, Flex, Text, Skeleton, ChartIcon, CommunityIcon, SwapIcon } from '@twinkykms/rubyswap-uikit'
  ...
  return (
    <Flex justifyContent="center" alignItems="center" flexDirection="column">
      ...
      <Text textAlign="center" color="textSubtle">
        {t('RubySwap has the most users of any decentralized platform, ever.')}
      </Text>
      <Flex flexWrap="wrap">
