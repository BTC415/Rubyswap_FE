...
import { Flex, Text, Skeleton, Link, Button, ArrowForwardIcon } from '@twinkykms/rubyswap-uikit'
...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in RUBY prizes this round', { cakePrizeInUsd: cakePriceBusdAsString })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with RUBY, win RUBY if your numbers match')}
        </Text>
      </Flex>
