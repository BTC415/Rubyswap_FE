...
import { Flex, Text, Skeleton, Link, Button, ArrowForwardIcon, Heading } from '@twinkykms/rubyswap-uikit'
...
const PredictionCardContent = () => {
  ...
  const bnbWonText = t('$%bnbWonInUsd% in EGEM won so far', { bnbWonInUsd: localisedBnbUsdString })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="#280D5F" mb="40px">
          {t('Will EGEM price rise or fall? guess correctly to win!')}
        </Text>
      </Flex>
