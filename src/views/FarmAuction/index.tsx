...
import { Button, Heading, Text, Flex, Link } from '@twinkykms/rubyswap-uikit'
        ...
        <Flex flexDirection={['column-reverse', 'row']}>
          <Left>
            ...
            <Text bold fontSize="16px" color="textSubtle" mb="24px">
              {t('Each week, qualifying projects can bid RUBY for the right to host a 7-day Farm on RubySwap.')}
            </Text>
