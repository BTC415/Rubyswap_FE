...
import { Flex, Button, Text, AutoRenewIcon, PresentWonIcon } from '@twinkykms/rubyswap-uikit'
  ...
  const handleClaim = async () => {
    ...
    try {
      ...
      if (receipt.status) {
        toastSuccess(
          t('Prizes Collected!'),
          t('Your RUBY prizes for round %lotteryId% have been sent to your wallet', { lotteryId }),
        )
        setPendingTx(false)
