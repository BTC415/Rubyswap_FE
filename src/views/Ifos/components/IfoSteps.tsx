...
import { Stepper, Step, StepStatus, Card, CardBody, Heading, Text, Button, Link, OpenNewIcon } from '@twinkykms/rubyswap-uikit'
    ...
    switch (step) {
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('You’ll need an active RubySwap Profile to take part in an IFO!')}
            </Text>
            {isStepValid ? (
      ...
      case 1:
        return (
          <CardBody>
            <Heading as="h4" color="secondary" mb="16px">
              {t('Get RUBY-EGEM LP Tokens')}
            </Heading>
            <Text color="textSubtle" small>
              {t('Stake RUBY and EGEM in the liquidity pool to get LP tokens.')} <br />
              {t('You’ll spend them to buy IFO sale tokens.')}
            </Text>
            <Button
              as={Link}
              external
              href={`${BASE_ADD_LIQUIDITY_URL}/EGEM/0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82`}
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent RUBY-EGEM LP tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )
