...
import { CardBody, PlayCircleOutlineIcon, Button, useTooltip, ArrowUpIcon, ArrowDownIcon } from '@twinkykms/rubyswap-uikit'
...
const OpenRoundCard: React.FC<OpenRoundCardProps> = ({
  ...
  const { targetRef, tooltipVisible, tooltip } = useTooltip(
    <div style={{ whiteSpace: 'nowrap' }}>{`${formatBnbv2(betAmount)} EGEM`}</div>,
    { placement: 'top' },
  )
