...
import { CardBody, Text, Flex, BlockIcon, LinkExternal } from '@twinkykms/rubyswap-uikit'
      ...
      <CardBody p="16px">
        ...
        <RoundResultBox>
          <Flex flexDirection="column" alignItems="center">
            ...
            <LinkExternal href="https://docs.rubyswap.finance/products/prediction" external>
              {t('Learn More')}
            </LinkExternal>
          </Flex>
        </RoundResultBox>
